#!/usr/bin/env node
/**
 * Frontend Build Script for Network 1 (192.168.0.106)
...
const NETWORK_CONFIG = {
    networkId: 'network1',
    networkIp: '192.168.0.106',
    apiBaseUrl: 'http://192.168.0.106/api',
    buildDir: 'C:/barcode-app/frontend-network1',
    port: 80,
    sslPort: 443
};

console.log('🌐 Building Frontend for Network 1 (192.168.0.106)...');
...
const envContent = `# Network 1 Configuration
...
VITE_APP_TITLE=Barcode Management System - Network 1
...
console.log('✅ Created .env.production file for Network 1');
...
const networkConfig = `
// Network 1 specific configuration
...
console.log('✅ Updated vite.config.ts for Network 1');
...
try {
    ...
    console.log('🔨 Building application for Network 1...');
  ...
  <script>
    ...
    console.log('✅ Frontend build for Network 1 completed successfully!');
