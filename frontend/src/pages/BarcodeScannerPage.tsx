...
const SEWING_DEFECTS = [
  'تفويت غرز',
  'غرزة واسعة / ضيقة',
  'شد في الخياطة (مكرمشة)',
  'خياطة مفتوحة',
  'الخياطة مش مستقيمة',
  'تركيب غلط (كم / ياقة / جيب)',
  'عدم تماثل',
  'خيوط سايبة',
  'سوستة بايظة / راكبة غلط',
  'زرار واقع / مش متثبت كويس',
  'إكسسوار ناقص / راكب غلط',
];
